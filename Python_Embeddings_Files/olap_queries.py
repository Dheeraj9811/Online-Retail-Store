...
# -- GETTING THE SUM OF ALL THE PRODUCT GROUPED BY THE PRODCUT_ID AND CUSTOMER_ID (ROLLUP)
q4 = """
SELECT
...
# -- GETTING THE CUSTORMER WHO HAVE PURCHASED THE PRODUCT 78 AND TOTAL REVENUE FROM IT
q5 = """
SELECT
...
def print_menu(cursor):
    ...
    while True:
        menu = """
OLAP 1. ROLLUP
OLAP 2. GETTING THE CUSTORMER WHO HAVE PURCHASED THE PRODUCT 78 AND TOTAL REVENUE FROM IT
OLAP 3. DRILL DOWN
OLAP 4. PIVOT_TABLE
OLAP 5. EXIT
YOUR ENTRY ->
"""
        ...
        input_menu = input()
        if input_menu == "1":
            execute_query(cursor, q4)
        elif input_menu == "2":
            execute_query(cursor, q5)
        elif input_menu == "3":
            execute_query(cursor, q6)
        elif input_menu == "4":
            execute_query(cursor, q7)
        elif input_menu == "5":
